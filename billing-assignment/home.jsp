<%@ page import="java.sql.*" %>
    <%@ page import="java.io.*" %>
        ...
        <body>
            <% Connection conn=null; Statement stmt=null; try { Class.forName("com.mysql.jdbc.Driver");
                conn=DriverManager.getConnection("jdbc:mysql://localhost:3306/demo", "root" , "" ); if (conn !=null) {
                ...
                out.println("&emsp;&emsp;<a href='addToCart.html'>View Cart</a>");
                rs.close();
